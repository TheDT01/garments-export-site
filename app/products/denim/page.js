export const metadata = {
  title: "Denim — Sapphire Design LTD",
  description: "Jeans & jackets with controlled washes.",
};
    ...
    <section className="space-y-10">
      <div className="rounded-3xl bg-gradient-to-br from-slate-50 via-white to-indigo-50 border p-8 md:p-14">
        ...
        <p className="mt-4 text-gray-600 md:text-lg">
          Jeans & jackets with controlled washes.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          Image gallery and 360° product viewer for Denim.
        </p>
      </div>
