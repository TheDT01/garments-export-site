export const metadata = {
  title: "Printing — Sapphire Design LTD",
  description: "Screen, digital & heat transfer.",
};
    ...
    <section className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          ...
          finishing techniques for Printing.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          Image gallery and 360° product viewer for Printing.
        </p>
      </div>
