export const metadata = {
  title: "Woven — Sapphire Design LTD",
  description: "Shirts, chinos, casual dresses.",
};
    ...
    <section className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          ...
          finishing techniques for Woven.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          Image gallery and 360° product viewer for Woven.
        </p>
      </div>
