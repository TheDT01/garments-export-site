export const metadata = {
  title: "Jackets — Sapphire Design LTD",
  description: "Light padded, softshell, windbreakers.",
};
    ...
    <section className="space-y-10">
      <div className="rounded-3xl bg-gradient-to-br from-slate-50 via-white to-indigo-50 border p-8 md:p-14">
        ...
        <p className="mt-4 text-gray-600 md:text-lg">
          Light padded, softshell, windbreakers.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          ...
          finishing techniques for Jackets.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          Image gallery and 360° product viewer for Jackets.
        </p>
      </div>
