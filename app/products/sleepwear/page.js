export const metadata = {
  title: "Sleepwear — Sapphire Design LTD",
  description: "Soft handfeel & comfort.",
};
    ...
    <section className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          ...
          finishing techniques for Sleepwear.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          Image gallery and 360° product viewer for Sleepwear.
        </p>
      </div>
