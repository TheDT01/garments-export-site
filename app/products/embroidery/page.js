export const metadata = {
  title: "Embroidery — Sapphire Design LTD",
  description: "Flat, 3D & appliqué.",
};
  ...
  return (
    <section className="space-y-10">
      <div className="rounded-3xl bg-gradient-to-br from-slate-50 via-white to-indigo-50 border p-8 md:p-14">
        ...
        <p className="mt-4 text-gray-600 md:text-lg">Flat, 3D & appliqué.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          ...
          finishing techniques for Embroidery.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          Image gallery and 360° product viewer for Embroidery.
        </p>
      </div>
