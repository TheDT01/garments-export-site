export const metadata = {
  title: "Sportswear — Sapphire Design LTD",
  description: "Performance knits & active sets.",
};
    ...
    <section className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          ...
          finishing techniques for Sportswear.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">
          Image gallery and 360° product viewer for Sportswear.
        </p>
      </div>
